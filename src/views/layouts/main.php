...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= ROOT ?>public/resources/css/natox.css?v=<?= Config::get("version") ?>">
...
<body>
    ...
    <script src="<?= ROOT ?>public/resources/js/jquery-3.6.0.min.js"></script>
