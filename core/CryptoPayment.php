...
class CryptoPayment
{
    ...
    public function createTransaction($amount, $currency, $charge, $metadata = array(), $redirectUrl = '', $cancelUrl = '')
    {
        ...
        $chargeObj->logo_url = $charge && isset($charge['logo_url']) ? $charge['logo_url'] : Session::get('imagesUrl') . 'resources/logo.png';
    ...
    public function coinbaseRequest($requestPath, $requestMethod, $body = null, $additionalHeaders = null)
    {
        ...
        $result = CoreHelpers::httpRequest($url, $requestMethod, $body, $headers);
        return $result;
    }
}